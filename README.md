...
This repository contains [the ranked-programming package](https://pkgs.racket-lang.org/package/ranked-programming) for use with [Racket](https://racket-lang.org), a programming language based on the Scheme dialect of LISP. This package is an implementation of the approach described in the paper [Ranked Programming](https://github.com/tjitze/ranked-programming/blob/master/documentation/ranked_programming.pdf). This paper will be presented at the IJCAI 2019 conference (August 10-16, Macao, China).
